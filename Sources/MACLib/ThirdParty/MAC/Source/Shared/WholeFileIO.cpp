...
CWholeFileIO * CWholeFileIO::CreateWholeFileIO(IAPEIO * pSource, int64 nSize)
{
    ...
    else if (nSize == n32BitSize)
    {
        ...
        {
            // if we catch the whole file should not have been created
            // we'll delete it just to be safe
            spWholeFile.Delete();
        }
